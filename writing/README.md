...
All three describe work on a private codebase. No proprietary logic, employer-identifying detail, account identifiers, or endpoints appear in any of them; cost figures refer to infrastructure I provision, compared against published vendor pricing at the time. The mechanisms generalize — that is why they are written down.
