...
- **Observability platform.** Sole author of the OpenTelemetry instrumentation library adopted by **18 services**, and sole author of the self-hosted Loki/Grafana/Tempo/Mimir + Pyroscope backend it reports to — Terraform on AWS, **~$125/month** against a costed **$1–3k/month** SaaS alternative. → [write-up](https://github.com/hjaraujof/hjaraujof/blob/main/writing/self-hosted-observability.md)
